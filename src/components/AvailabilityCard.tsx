              ...
              <ul className="decoration-none list-disc pl-4">
                {data?.skills.technical
                  ...
                  <>
                    ...
                    <li>React.js, Node.js, Express.js, MangoDb</li>
      ...
      <div className="mt-10">
        ...
        <p className="text-foreground text-sm">
          {data?.experience.internshipCompleted ||
            "Selected as Infosys Developer Trainee from 10,000+ applicants; completed virtual internships at Accenture, Deloitte, and NullClass Technologies."}{" "}
          <br />
          {data?.achievements[0] ||
            "Built ML model achieving 88% F1-score for book genre classification; ranked in top 10% in university coding contests."}{" "}
          <br />
          {data?.experience.freelanceWork ||
            "Delivered 25+ automation projects reducing manual workloads by 60%; solved 200+ problems on LeetCode (5-star, 2000+ contest rating) and earned CodeChef 3-star (1700+ rating)"}
        </p>
      </div>
